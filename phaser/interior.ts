...
class interior extends Phaser.Scene {
    ...
    preload () {
        this.load.image("interior", "/backgrounds/interior.png");
    ...
    create () {
        this.add.image(0, 0, 'interior').setOrigin(0, 0);
        ...
        document.getElementById("interior_id")?.onclick = () => {this.scene.start("interior")};
