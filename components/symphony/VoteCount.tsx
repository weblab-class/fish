export default function VoteCount(props: {
  ...
  return (
    <div className="z-50 ml-2 mr-2 h-2/5 w-1/5">
      ...
      >
        <p className="w-full break-words rounded-2xl bg-[url[/backgrounds/brownBg.png]] p-1 pl-15% text-left text-amber-950">
        ...
        <div className="h-1/12 absolute flex w-1/5 justify-end">
