...
export default function ChatLogPhaser(props: {
  ...
  return (
    ...
    >
      {showChat ? (
        <div
          className="z-50 h-full  w-full overflow-x-hidden overflow-y-scroll rounded-t-2xl border-4 border-b-0 bg-amber-950 bg-opacity-20 p-1 pr-3 text-black scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-pink-300 scrollbar-corner-red-300 scrollbar-track-rounded-3xl"
          ref={chatLogRef}
          onClick={() => {
            setShowChat(false);
          }}
